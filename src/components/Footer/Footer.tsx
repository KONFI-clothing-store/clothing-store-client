      ...
      <Container>
        <div className="flex items-start justify-between gap-x-6 max-md654:grid max-md654:gap-y-4">
          ...
          <div className="flex flex-col items-end max-md654:items-center">
            <p className="font-integral_cf text-2xl mb-[25px] max-md:text-xl">STAY UPTO DATE ABOUT OUR LATEST OFFERS</p>
        ...
        <div className="flex items-center justify-between max-md654:flex-col max-md654:gap-y-3">
          <p className="text-sm opacity-60">Shop.co © 2000-2023, All Rights Reserved</p>

          <div className="flex items-center gap-x-3">
            {PAYMENT_ITEMS.map((item) => (
              <div className="w-[46px] h-[30px] bg-white rounded-[5.38px] px-1.5 py-[8px]" key={item.id}>
