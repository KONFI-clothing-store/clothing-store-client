    ...
    <Container>
      ...
      <div className="flex gap-[50px] mb-10 mt-6 max-md:grid max-md:gap-5">
        <div className="grid gap-[50px] w-[48%] h-full max-md:h-auto max-md:gap-5 max-md:w-full">
          <Link to="t-shirts" className="group block h-[491px] rounded-[20px] overflow-hidden relative max-md:max-h-[300px]">
            <p
          ...
          <Link to="shorts" className="group rounded-[20px] h-[357px] overflow-hidden relative max-md:max-h-[300px]">
            <p
              className="absolute top-4 right-10 text-[36px] font-bold z-50 max-md:text-[28px] max-md:right-5 max-md:top-2"
              style={{ textShadow: "0px 0px 7px rgba(255, 255, 255, 1)" }}
            >
        ...
        <div className="grid gap-[50px] w-[48%] h-full max-md:h-auto max-md:gap-5 max-md:w-full">
          <Link to="shirts" className="group h-[357px] rounded-[20px] overflow-hidden relative max-md:max-h-[300px]">
            <p
          ...
          <Link to="jeans" className="group h-[491px] rounded-[20px] overflow-hidden relative max-md:max-h-[300px]">
            <p
